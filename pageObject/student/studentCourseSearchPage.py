...
class StudentCourseSearchPage(BasePage):
    """管理员查询课程"""
    '''从excel表格中读取元素定位方式'''
    ...
    #管理员查询课程
    studentSearchCourseEle = (By.XPATH, eleData.readExcel(83, 3))
    ...
    courseTableEle = (By.XPATH, eleData.readExcel(82, 3))
    ...
    def clickChooseCSBtn(self):
        ...
        print("定位成功")
    # 查询课程按钮
    def clickSearchCourseTipBtn_student(self):
        self.locator_element(*self.studentSearchCourseEle).click()
    ...
    def isSearchCorrect(self):
        if self.getCourseNameFromSql() == self.getCourseNameValue():
            return True
        else:
            return False
